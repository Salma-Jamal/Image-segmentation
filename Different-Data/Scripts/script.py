...
wandb.init(project="Segmentation",
          name="Segformer-b5-MandMsData")


path_ed = '/home/saahmed/scratch/projects/Image-segmentation/datasets/MAndMs/processed_data/Training/ed/images/'
path_es = '/home/saahmed/scratch/projects/Image-segmentation/datasets/MAndMs/processed_data/Training/es/images/'
...
path_ed = '/home/saahmed/scratch/projects/Image-segmentation/datasets/MAndMs/processed_data/Training/ed/masks/'
path_es = '/home/saahmed/scratch/projects/Image-segmentation/datasets/MAndMs/processed_data/Training/es/masks/'
...
# Second split: train and val (e.g., from 80%, take 75% for train → 60% total)
...
class DatasetConfig:
    ...
    DATASET_PATH: str = '/home/saahmed/scratch/projects/Image-segmentation/datasets/MAndMs/processed_data/'
 

@dataclass(frozen=True)
class Paths:
    # DATA_TRAIN_IMAGES_ED: str = os.path.join(DatasetConfig.DATASET_PATH, "Training",'ed', "images", r"*.png")
    # DATA_TRAIN_LABELS_ED: str = os.path.join(DatasetConfig.DATASET_PATH, "Training",'ed' ,"masks",  r"*.png")

    # DATA_TRAIN_IMAGES_ES: str = os.path.join(DatasetConfig.DATASET_PATH, "Training",'es', "images", r"*.png")
    # DATA_TRAIN_LABELS_ES: str = os.path.join(DatasetConfig.DATASET_PATH, "Training",'es' ,"masks",  r"*.png")
...
def num_to_rgb(num_arr):
    ...
    output = np.zeros(single_layer.shape + (3,))
    
    unique_vals = np.unique(single_layer)
    
    if np.array_equal(unique_vals, np.array([0, 127, 255])):
        color_map = id2color2
    else:
        color_map = id2color
...
def display_image_and_mask(*, images, masks):
    ...
    for idx in range(images.shape[0]):
        ...
        rgb_gt_mask = num_to_rgb(grayscale_gt_mask)
...
class MedicalSegmentationModel(pl.LightningModule):
    def __init__(
        ...
        # self.label_mapping2 = {0: 0, 255: 2, 127: 1}
    ...
    #     print(f"epoch= {self.current_epoch},  mean_train_loss = {self.mean_train_loss},  mean_train_f1= {self.mean_train_f1}")
    ...
    #     self.log("epoch", self.current_epoch)
    #     print(f"epoch= {self.current_epoch},  mean_valid_loss = {self.mean_valid_loss},  mean_valid_f1= {self.mean_valid_f1}")

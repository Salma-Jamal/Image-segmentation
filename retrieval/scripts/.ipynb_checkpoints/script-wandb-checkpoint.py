...
# simclr_radDino_posPairs_augPairs
parser = argparse.ArgumentParser(description="Process arguments.")
parser.add_argument("--name", type=str, help="Enter run name")
...
class Config:
    def __init__(self):
        ...
        self.base_path =  f"/home/saahmed/scratch/projects/Image-segmentation/retrieval/checkpoints/{args.name}" #"./output_models"
        os.makedirs(self.base_path, exist_ok=True)
        self.best_model_path = os.path.join(self.base_path, "best_model")
        self.last_model_path = os.path.join(self.base_path, "last_model")
...
wandb.init(
    ...
    name=args.name,  # simclr_radDino_posPairs_augPairs
    config={
...
# Optionally, log a final training plot to wandb
# plot_training(train_loss_history, config.learning_plot_path, val_loss_history)
# wandb.log({"learning_curve": wandb.Image(config.learning_plot_path)})
